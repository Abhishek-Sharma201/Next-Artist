        ...
        <div className="sideNav">
            <ul className="list">
                ...
                <li className="item" onClick={() => handleTabChange('Subscribers')}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-emoji-sunglasses" viewBox="0 0 16 16">
                ...
                <li className="item" onClick={() => handleTabChange('Emails')}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-envelope-check" viewBox="0 0 16 16">

        ...
        <section className="hero-section">
            <div className="hand-made-sketch" id='about'>
                <div className="heading">
                    <h1>Shop Handmade Sketch</h1>
                    <h2>Unique & Perfect gift for all</h2>
                </div>
                <div className="sketch">
                    <HandMadeSketchCard image={IMG_12} type={'Graphite Sketch'} price={'₹1000 / 4.5 rating'} />
                    <HandMadeSketchCard image={IMG_17} type={'Color Pencile Sketch'} price={'₹1000 / 4.5 rating'} />
                    <HandMadeSketchCard image={IMG_18} type={'Charcoal Sketch'} price={'₹1000 / 4.5 rating'} />
                </div>
            </div>
            ...
            <div className="my-album-section" id='album'>
                <h1 className="head">My Albums</h1>
                <div className="content">
                    <div className="text">
                        <p>
                            Collection of detailed sketches
                            and portraits capturing human
                            expressions,emotions, and moments
                            through pencil and charcoal artistry.
                        </p>
                        <ShopBtn value={'View all'} />
                    </div>
                    <div className="imgs">
            ...
            <div className="why-choose-us" id='contact'>
                ...
                <div className="content">
                    <div className="svg-container">
                        <div className="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-patch-check-fill" viewBox="0 0 16 16">
                    ...
                    <div className="svg-container">
                        <div className="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-hand-index-thumb-fill" viewBox="0 0 16 16">
                    ...
                    <div className="svg-container">
                        <div className="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-chat-left-text-fill" viewBox="0 0 16 16">
            ...
            <div className="testimonial">
                ...
                <div className="container">
                    <div className="left">
                        <Image src={USER_IMG1} priority={true} className='img' alt='img' />
                    </div>
                    <div className="right">
                        <p>
                            This sketch impresses with its meticulous detail and expressive lines.
                            The shading adds depth, while the composition captures a perfect blend of realism and artistry
                        </p>
            ...
            <div className="tamplate">
                <div className="container">
                    <div className="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="#FED255" className="bi bi-megaphone-fill" viewBox="0 0 16 16">

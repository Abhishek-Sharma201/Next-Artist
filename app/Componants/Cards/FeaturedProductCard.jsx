    ...
    return (
        <div className='featuredProductCard'>
            <div className="img-container">
                <Image src={cardImage} alt='img' priority={true} className='featuredProductCardImg' />
                <div className="icon" onClick={handleLike}>
                    {(isLiked)
                        ?
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gold" className="bi bi-heart-fill" viewBox="0 0 16 16">

...
const page = () => {
    ...
    const handleContactSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://localhost:8100/api/contactSubmit', {
                method: 'POST',
    ...
    const handleSubscribeSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch('http://localhost:8100/api/subs', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
        ...
        <>
            ...
            <section className="contact">
                ...
                <div className="get-in">
                    <h1>Get in Touch!</h1>
                    <h2>Can't Find Your Answers On Our Website? Reach Out To Our Support Team.</h2>
                </div>
                <div className="container">
                    <div className="subscribe">
                        ...
                        <form className="input-submit" onSubmit={handleSubscribeSubmit}>
                            <input type="email" name="email" id="email" placeholder="Enter Your Email Address" value={subsEmail.email} onChange={subsInput} required />
                    ...
                    <div className="form">
                        <form onSubmit={handleContactSubmit}>
                            ...
                            <div className="inp-box">
                                ...
                                <input type="text" name="email" id="email" placeholder='Email' pattern="^([a-zA-Z0-9_\-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([a-zA-Z0-9\-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$" value={formData.email} onChange={handleChange} required />
                            </div>
                            <div className="inp-box">
                                ...
                                <input type="text" name="phone" id="phone" placeholder='Phone' minlength='10' maxlength='10' value={formData.phone} onChange={handleChange} required />
                            </div>
                            <textarea type="text" className='message' name="message" id="message" placeholder='Type your Message...' value={formData.message} onChange={handleChange} required />
